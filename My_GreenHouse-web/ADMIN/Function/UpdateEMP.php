<?php  
  ...
  if(!isset($_SESSION['user']) || empty($_SESSION['user'])){
    ...
    $dat = date("Y-m-d H:i:s");
        ...
        $sql = " UPDATE chef SET fonction='$fonction',salair='$salair', fname='$fname', lname='$lname', adress='$address', tele='$tele',city='$city', country='$country', postal='$postal', date='$dat' WHERE idemp=$id ";
        $stmt = $db->query($sql);

      try {
        $stmt->execute([$fonction, $salair, $fname, $lname, $address, $tele, $city, $country,$postal, $dat]);
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" disabled placeholder="" value="<?php echo $email; ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
