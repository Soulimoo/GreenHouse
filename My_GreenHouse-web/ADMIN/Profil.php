...
<?php
    ...
    if(isset($_POST['update'])){   
        ...
        $sql = " UPDATE admin SET fname=?, lname=?, adress=?, city=?, country=?, postal=?,about=?, date=? WHERE ID=? ";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param('sssssissi', $fname, $lname, $adress, $city, $country, $postal, $about, $dat, $id);
        if ($stmt->execute()) {
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="5" name="about" class="form-control" value="<?php echo $about; ?>" placeholder="Biography"></textarea>
                                                </div>
                                            </div>
                                        </div>
