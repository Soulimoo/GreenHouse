<?php
  ...
  if (isset($_POST['update'])) {
    ...
    $emailQuery = "SELECT * FROM chef WHERE email=? AND pass=? LIMIT 1";
    ...
    if (password_verify($CurrPassword, $row['pass'])) {
    ...
    if (count($errors) === 0) {
      ...
      $sql = "UPDATE chef SET pass=?, date=? WHERE email=?";
                                ...
                                <div class="content" style="">
                                    <form action="Setting.php" method="POST">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" id="email" name="email" class="form-control"disabled placeholder="" value="<?php echo $chef;?>" placeholder="Your Email" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="Password" id="CurrentPassword" name="CurrentPassword" class="form-control" placeholder="Your Password">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <button type="submit" name="update" class="btn btn-success btn-fill pull-right">Update</button></p>
